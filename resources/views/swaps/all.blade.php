...
<div class="flex justify-center">
    <div class="flex flex-wrap lg:flex-nowrap lg:space-x-5 justify-center w-5/6 h-4/6">
        <div class="flex flex-col items-center w-full bg-neutral-700 rounded px-4 py-4  mt-10">
            ...
            @if (count($swapsSent) != 0)
                @foreach ($swapsSent as $swap)
                    ...
                    <a href="{{route('show-swap', ['swap' => $swap->id])}}" class="my-4">
                        <div class="flex flex-wrap sm:flex-nowrap items-center mx-4 my-4 justify-between border-b border-neutral-400">
        ...
        <div class="flex flex-col items-center w-full bg-neutral-700 rounded px-4 py-4  mt-10">
            ...
            @if (count($swapsReceived) != 0)
                @foreach ($swapsReceived as $swap)
                    ...
                    @endphp
                    <a href="{{route('show-swap', ['swap' => $swap->id])}}" class="my-4">
                        <div class="flex flex-wrap sm:flex-nowrap items-center mx-4 justify-between border-b border-neutral-400">
